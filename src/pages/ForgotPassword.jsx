    ...
    <div className="min-h-screen flex items-center justify-center p-4 grid-bg bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900 light:bg-slate-100">
      ...
      <div className="w-full max-w-md animate-slide-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2 font-display text-slate-100 light:text-slate-900">Reset password</h1>
          <p className="text-sm text-slate-500">Enter your email and we'll send you a reset link</p>
        </div>

        <div className="rounded-2xl p-8 bg-cyan-500/[0.04] border border-cyan-500/15 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.3)] light:bg-white/90 light:border-slate-200">
          {sent ? (
            <div className="text-center space-y-4 py-2">
              ...
              <div>
                <h3 className="text-lg font-bold mb-1 font-display text-slate-100 light:text-slate-900">Check your inbox</h3>
              ...
              <div className="rounded-xl p-4 text-left space-y-2 bg-white/[0.03] border border-white/[0.06] light:bg-black/[0.03] light:border-slate-200">
